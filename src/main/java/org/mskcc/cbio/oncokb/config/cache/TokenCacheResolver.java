...
public class TokenCacheResolver implements CacheResolver {
    ...
    public static String TOKENS_BY_USER_LOGIN_CACHE = "tokensByUserLogin";
    ...
    public Collection<? extends Cache> resolveCaches(CacheOperationInvocationContext<?> context) {
        ...
        } else if (context.getMethod().getName() == "findByUserLogin") {
            caches.add(cacheManager.getCache(this.cacheNameResolver.getCacheName(TOKENS_BY_USER_LOGIN_CACHE)));
        } else {
