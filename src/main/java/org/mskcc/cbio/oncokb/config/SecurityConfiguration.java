    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .contentSecurityPolicy(
              "default-src 'self'; " +
              "frame-src 'self' https://*.google.com https://www.recaptcha.net https://*.oncokb.org https://*.youtube-nocookie.com https://*.bilibili.com https://*.gitbook.com; " +
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.google.com/ https://storage.googleapis.com www.google-analytics.com https://www.googletagmanager.com https://recaptcha.net https://www.gstatic.com https://cscript-cdn-use.cassiecloud.com https://cscript-cdn-use.oncokb.org; " +
