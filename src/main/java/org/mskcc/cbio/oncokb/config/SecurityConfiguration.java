...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            .headers()
            .contentSecurityPolicy("default-src 'self'; frame-src 'self' https://*.google.com https://www.recaptcha.net https://*.oncokb.org https://*.youtube-nocookie.com https://*.bilibili.com https://*.gitbook.com https://*.gitbook.io; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.google.com/ https://storage.googleapis.com www.google-analytics.com https://www.googletagmanager.com https://recaptcha.net https://www.gstatic.com https://*.heapanalytics.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: www.google-analytics.com https://heapanalytics.com; font-src 'self' data:; connect-src 'self' https://*;")
        .and()
        ...
        .and()
            ...
            .antMatchers("/api/account/reset-password/info").permitAll()
            ...
            .antMatchers(HttpMethod.GET, "/api/user-banner-messages/active").permitAll()
