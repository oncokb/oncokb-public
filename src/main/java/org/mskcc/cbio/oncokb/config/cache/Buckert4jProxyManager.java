...
public class Buckert4jProxyManager extends AbstractCompareAndSwapBasedProxyManager<String> {

    private final CommandExecutor commandExecutor;
    private final long ttlMillis;

    public Buckert4jProxyManager(CommandExecutor commandExecutor, Duration ttl) {
        this(commandExecutor, ClientSideConfig.getDefault(), ttl);
    }

    public Buckert4jProxyManager(CommandExecutor commandExecutor, ClientSideConfig clientSideConfig, Duration ttl) {
