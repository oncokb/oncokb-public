...
public enum DropdownEmailOption {
    ...
    , CLARIFY_HOSPITAL_USE(new DropdownEmailOptionBuilder()
        .blockId(BlockId.HOSPITAL_USE_CLARIFICATION_NOTE)
        .actionId(ActionId.SEND_HOSPITAL_USE_CLARIFICATION_EMAIL)
        .confirmActionId(ActionId.CONFIRM_SEND_HOSPITAL_USE_CLARIFICATION_EMAIL)
        .mailType(MailType.CLARIFY_HOSPITAL_USE)
        .category(DropdownEmailCategory.LICENSE)
        .specificLicense(LicenseType.HOSPITAL)
        .dropdownKey("Send Hospital Use Clarification Email")
        .modalTitle("Hospital Use Clarify")
        .modalSubject(ModalEmailSubject.DEFAULT)
        .collapsedNote("Sent hospital use clarification email")
        .expandedNote("We have sent a clarification email to the user asking for more detail on their hospital use case."))
    , HOSPITAL_APPROVAL_HIGH_VOLUME(new DropdownEmailOptionBuilder()
        .blockId(BlockId.HOSPITAL_APPROVAL_HIGH_VOLUME_NOTE)
        .actionId(ActionId.SEND_HOSPITAL_APPROVAL_HIGH_VOLUME_EMAIL)
        .confirmActionId(ActionId.CONFIRM_SEND_HOSPITAL_APPROVAL_HIGH_VOLUME_EMAIL)
        .mailType(MailType.HOSPITAL_APPROVAL_HIGH_VOLUME)
        .category(DropdownEmailCategory.LICENSE)
        .specificLicense(LicenseType.HOSPITAL)
        .dropdownKey("Hospital Approval API Inquiry")
        .modalTitle("Hospital Approval")
        .modalSubject(ModalEmailSubject.DEFAULT)
        .collapsedNote("Sent hospital approval high volume email")
        .expandedNote("We have sent an approval email to the user and asked whether they are interested in learning more about API access."))
    , CLARIFY_COMMERCIAL_USE(new DropdownEmailOptionBuilder()
        .blockId(BlockId.COMMERCIAL_USE_CLARIFICATION_NOTE)
        .actionId(ActionId.SEND_COMMERCIAL_USE_CLARIFICATION_EMAIL)
        .confirmActionId(ActionId.CONFIRM_SEND_COMMERCIAL_USE_CLARIFICATION_EMAIL)
        ...
        .dropdownKey("Send Commercial Use Clarification Email")
        .modalTitle("Commercial Clarify")
        .modalSubject(ModalEmailSubject.DEFAULT)
        .collapsedNote("Sent commercial use clarification email")
        .expandedNote("We have sent a clarification email to the user asking for more detail on their commercial use case and licensing needs."))
