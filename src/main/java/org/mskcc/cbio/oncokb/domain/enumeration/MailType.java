...
public enum MailType {
    ...
    , API_ACCESS_APPROVAL(new MailTypeBuilder()
        .templateName("apiAccessApprovalEmail")
        .description("API Access Approval")
        .titleKey("email.apiAccess.title"))
    ...
    , CLARIFY_HOSPITAL_USE(new MailTypeBuilder()
        .templateName("clarifyHospitalUse")
