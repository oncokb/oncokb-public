...
import { getUsers } from 'app-backup/modules/administration/user-management/user-management.reducer';
...
// tslint:disable-next-line:no-unused-variable
import { convertDateTimeFromServer, convertDateTimeToServer } from 'app-backup/shared/util/date-utils';
import { mapIdList } from 'app-backup/shared/util/entity-utils';
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : tokenEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="token-creation" type="date" className="form-control" name="creation" />
                </AvGroup>
                <AvGroup>
                  <Label id="expirationLabel" for="token-expiration">
                    Expiration
                  </Label>
                  <AvField id="token-expiration" type="date" className="form-control" name="expiration" />
                </AvGroup>
                <AvGroup>
