...
import { ITokenStats } from 'app-backup/shared/model/token-stats.model';
...
export class TokenStatsDeleteDialog extends React.Component<ITokenStatsDeleteDialogProps> {
  componentDidMount() {
    this.props.getEntity(this.props.match.params.id);
  }

  confirmDelete = event => {
    this.props.deleteEntity(this.props.tokenStatsEntity.id);
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-tokenStats" color="danger" onClick={this.confirmDelete}>
