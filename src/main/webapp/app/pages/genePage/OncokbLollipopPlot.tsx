...
export default class OncokbLollipopPlot extends React.Component<
  ...
  {}
> {
  @observable hidePlotControls = true;
  ...
  render() {
    return (
      <div
        onMouseEnter={
          this.props.showPlotControlsOnHover
            ? () => (this.hidePlotControls = false)
            : undefined
        }
        onMouseLeave={
          this.props.showPlotControlsOnHover
            ? () => (this.hidePlotControls = true)
            : undefined
        }
      >
        ...
        <OncokbMutationMapper
          ...
          showPlotLegendToggle={!this.hidePlotControls}
          showPlotYMaxSlider={!this.hidePlotControls}
          showPlotDownloadControls={!this.hidePlotControls}
