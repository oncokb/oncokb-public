  ...
  public render() {
    ...
    return (
      <>
        ...
        <div bind-html="data.citationURL" style={{ marginBottom: 10 }} />
        <div className="top-download">
          <Button onClick={() => this.downloadData(DOWNLOAD_TYPE.ALL_CURATED_GENES, 'allCuratedGenes.txt')}>
            <FontAwesomeIcon icon={'cloud-download-alt'} fixedWidth />
            All Curated Genes
          </Button>
          <Button onClick={() => this.downloadData(DOWNLOAD_TYPE.ALL_ANNOTATED_VARIANTS, 'allAnnotatedVariants.txt')}>
            <FontAwesomeIcon icon={'cloud-download-alt'} fixedWidth />
            All Curated Alterations
          </Button>
          <Button onClick={() => this.downloadData(DOWNLOAD_TYPE.ALL_ACTIONABLE_ALTERATIONS, 'allActionableVariants.txt')}>
            <FontAwesomeIcon icon={'cloud-download-alt'} fixedWidth />
