        ...
        <Row>
          <Col>
            ...
            <p>
              ...
              investigational or hypothetical treatments) to individual
              mutational events. OncoKB currently contains treatment information
              for Level 1 and Level 2 (those alterations which are
              FDA-recognized or considered standard care biomarkers predictive
              of response to FDA-approved drugs in specific disease settings),
              Level 3 alterations (those alterations which are considered
              predictive of response based on promising clinical data to
