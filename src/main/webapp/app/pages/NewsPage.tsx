...
const UPDATED_IMPLICATION_COLUMNS = ['Level', 'Gene', 'Mutation', 'Tumor Type', 'Drug', 'Evidence'];
const UPDATED_IMPLICATION_BY_DATE = {
  '08282019': [
    [
      '3A',
      'EZH2',
...
const NEWLY_ADDED_GENES = {
  ...
  '08042019': ['ATXN7', 'MTAP', 'SERPINB3', 'SERPINB4'],
  '08282019': ['ARHGAP35', 'FOXF1', 'GAB1', 'MAD2L2', 'SMARCA2', 'SMARCE1']
};

const NEWLY_ADDED_LEVEL_FOUR = [
  {
    gene: 'ATM',
...
const UPDATED_ACTIONABLE_GENES = {
  '03072017': {
    '1': [
  ...
  '02022018': {
    ...
    '3': ['HRAS - Oncogenic mutations - Head and Neck Squamous Cell Carcinoma - Tipifarnib (<b>moved from 4 to 3A only for HNSCC</b>)']
  },
  '07122018': {
    '1': [
  ...
  '10012018': {
    '3': ['RET - Oncogenic Mutations - Medullary Thyroid Cancer - LOXO-292 (<b>added as new association</b>)']
  },
  '10262018': {
    '4': [
  ...
  '11022018': {
    '2': ['RET - Fusions - Non-Small Cell Lung Cancer - LOXO-292 (<b>added as new association</b>)']
  },
  '12142018': {
    '1': [
    ...
    '4': ['KDM6A - Oncogenic Mutations - Bladder Cancer - EZH2 inhibitors (<b>new association</b>)']
  },
  '01242019': {
    '1': [
  ...
  return (
    <div className="news">
      ...
      <div>
        <ul>
          <li>
            Updated therapeutic implications - {UPDATED_IMPLICATION_BY_DATE['08282019'].length} new heme{' '}
            {Pluralize('association', UPDATED_IMPLICATION_BY_DATE['08282019'].length)}
            <Row>
              <SimpleTable columns={UPDATED_IMPLICATION_COLUMNS} rows={UPDATED_IMPLICATION_BY_DATE['08282019']} />
            </Row>
          </li>
          <li>
            Addition of {NEWLY_ADDED_GENES['08282019'].length} new genes:
            <div className="newly-added-genes">
              {NEWLY_ADDED_GENES['08282019'].map(hugo => (
                <span className="m-2" ng-repeat="hugo in data.newlyAddedGenes['08282019']">
      ...
      <div>
        <ul>
          <li>
            Updated therapeutic implications - {UPDATED_IMPLICATION_BY_DATE['08042019'].length} new heme{' '}
            {Pluralize('association', UPDATED_IMPLICATION_BY_DATE['08042019'].length)}
            <Row>
              <SimpleTable columns={UPDATED_IMPLICATION_COLUMNS} rows={UPDATED_IMPLICATION_BY_DATE['08042019']} />
            </Row>
          </li>
          <li>
            Addition of {NEWLY_ADDED_GENES['08042019'].length} new genes:
            <div className="newly-added-genes">
              {NEWLY_ADDED_GENES['08042019'].map(hugo => (
                <span className="m-2" ng-repeat="hugo in data.newlyAddedGenes['08042019']">
                  <a href={`gene/{$hugo}`}>{hugo}</a>
                </span>
              ))}
            </div>
