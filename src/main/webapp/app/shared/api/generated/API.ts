...
export default class API {
    ...
    requestApiAccessUsingPOSTURL(parameters: {
        'apiAccessRequest': ApiAccessRequest,
        $queryParameters ? : any
    }): string {
        let queryParameters: any = {};
        let path = '/api/account/request-api-access';
     ...
     * requestApiAccess
     * @method
     * @name API#requestApiAccessUsingPOST
     * @param {} apiAccessRequest - apiAccessRequest
     */
    requestApiAccessUsingPOSTWithHttpInfo(parameters: {
        'apiAccessRequest': ApiAccessRequest,
        $queryParameters ? : any,
        $domain ? : string
    }): Promise < request.Response > {
        ...
        return new Promise(function(resolve, reject) {
            ...
            if (parameters['apiAccessRequest'] !== undefined) {
                body = parameters['apiAccessRequest'];
            }

            if (parameters['apiAccessRequest'] === undefined) {
                reject(new Error('Missing required  parameter: apiAccessRequest'));
                return;
            }
     ...
     * @param {} apiAccessRequest - apiAccessRequest
     */
    requestApiAccessUsingPOST(parameters: {
        'apiAccessRequest': ApiAccessRequest,
        $queryParameters ? : any,
        $domain ? : string
    }): Promise < any > {
        return this.requestApiAccessUsingPOSTWithHttpInfo(parameters).then(function(response: request.Response) {
            return response.body;
        });
    };
    ...
    revokeTrialAccessForCompanyUsingPOSTURL(parameters: {
        'id': number,
        $queryParameters ? : any
    }): string {
        let queryParameters: any = {};
        let path = '/api/companies/{id}/trial/revoke';
    ...
    /**
     * revokeTrialAccessForCompany
     * @method
     * @name API#revokeTrialAccessForCompanyUsingPOST
     * @param {integer} id - id
     */
    revokeTrialAccessForCompanyUsingPOSTWithHttpInfo(parameters: {
        'id': number,
        $queryParameters ? : any,
        $domain ? : string
    }): Promise < request.Response > {
     ...
     * @param {integer} id - id
     */
    revokeTrialAccessForCompanyUsingPOST(parameters: {
        'id': number,
        $queryParameters ? : any,
        $domain ? : string
    }): Promise < number > {
        return this.revokeTrialAccessForCompanyUsingPOSTWithHttpInfo(parameters).then(function(response: request.Response) {
            return response.body;
        });
    };
    ...
    getTerminationWarningEmailUsingGET(parameters: {
        ...
        return this.getTerminationWarningEmailUsingGETWithHttpInfo(parameters).then(function(response: request.Response) {
            return response.body;
        });
    };
    ...
    registrationSummaryGetUsingGETURL(parameters: {
        $queryParameters ? : any
    }): string {
        let queryParameters: any = {};
        let path = '/api/usage/summary/registrations';
    ...
    /**
     * registrationSummaryGet
     * @method
     * @name API#registrationSummaryGetUsingGET
     */
    registrationSummaryGetUsingGETWithHttpInfo(parameters: {
        $queryParameters ? : any,
            $domain ? : string
    }): Promise < request.Response > {
        const domain = parameters.$domain ? parameters.$domain : this.domain;
     ...
     * @name API#registrationSummaryGetUsingGET
     */
    registrationSummaryGetUsingGET(parameters: {
            $queryParameters ? : any,
                $domain ? : string
        }): Promise < Array < UserRegistrationSummary >
        > {
            return this.registrationSummaryGetUsingGETWithHttpInfo(parameters).then(function(response: request.Response) {
                return response.body;
            });
        };
    ...
    revokeTrialAccessUsingPOSTURL(parameters: {
        'login': string,
        $queryParameters ? : any
    }): string {
        let queryParameters: any = {};
        let path = '/api/users/{login}/trial/revoke';
     ...
     * revokeTrialAccess
     * @method
     * @name API#revokeTrialAccessUsingPOST
     * @param {string} login - login
     */
    revokeTrialAccessUsingPOSTWithHttpInfo(parameters: {
        'login': string,
        $queryParameters ? : any,
        $domain ? : string
    }): Promise < request.Response > {
     ...
     * @param {string} login - login
     */
    revokeTrialAccessUsingPOST(parameters: {
        'login': string,
        $queryParameters ? : any,
        $domain ? : string
    }): Promise < UserDTO > {
        return this.revokeTrialAccessUsingPOSTWithHttpInfo(parameters).then(function(response: request.Response) {
            return response.body;
        });
    };
}