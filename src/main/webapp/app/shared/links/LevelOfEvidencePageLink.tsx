import {LEVEL_TYPES, ONCOKB_TM, PAGE_ROUTE, PAGE_TITLE} from 'app/config/constants';
import React from 'react';
import {Link} from 'react-router-dom';
import {Version} from "app/pages/LevelOfEvidencePage";

const getLevelPageLink = (
  ...
  return (
    <Link to={getLevelPageLink(props.levelType, props.version)}>
      {props.children ? (
        ...
        <span>
          {getDefaultLinkContent(props.levelType, props.version)}
        </span>
      )}
    </Link>
  );
