...
const APIResponse1 = {
  ...
  highestSensitiveLevel: 'LEVEL_Dx1',
...
const APIResponse7 = {
  ...
  mutationEffect: {
    knownEffect: 'Unknown',
    description:
      'The BRAF V600H mutation has not specifically been reviewed by the OncoKB team. However, we have mutation effect descriptions for BRAF V600A/D/E/G/K/L/M/Q/R.',
    citations: { pmids: [], abstracts: [] },
  },
  highestSensitiveLevel: 'LEVEL_Dx1',
  highestResistanceLevel: null,
  highestDiagnosticImplicationLevel: 'LEVEL_Dx3',
  highestPrognosticImplicationLevel: null,
  highestFdaLevel: 'LEVEL_Fda2',
  otherSignificantSensitiveLevels: [],
  otherSignificantResistanceLevels: [],
  ...
  geneSummary:
    'BRAF, an intracellular kinase, is frequently mutated in melanoma, thyroid and lung cancers among others.',
  variantSummary:
    'The BRAF V600H mutation has been identified as a statistically significant hotspot and is likely to be oncogenic.',
  tumorTypeSummary: '',
  prognosticSummary: '',
  diagnosticSummary: '',
  diagnosticImplications: [
  ...
  treatments: [
    {
      alterations: ['V600'],
      drugs: [{ ncitCode: 'C106254', drugName: 'Tovorafenib' }],
      approvedIndications: [],
      level: 'LEVEL_Dx1',
      fdaLevel: 'LEVEL_Fda2',
      levelAssociatedCancerType: {
        ...
        color: 'Gray',
        name: 'Low-Grade Glioma, NOS',
        mainType: { id: null, name: 'Glioma', tumorForm: 'SOLID' },
        tissue: 'CNS/Brain',
        children: {},
        parent: 'ENCG',
        level: 3,
    ...
    {
      alterations: ['V600'],
      drugs: [{ ncitCode: 'C64768', drugName: 'Vemurafenib' }],
      approvedIndications: [
        'Vemurafenib is FDA-approved for the treatment of patients with unresectable or metastatic melanoma with the BRAF V600E mutation as detected by an FDA-approved test.',
      ],
      level: 'LEVEL_Dx1',
      fdaLevel: 'LEVEL_Fda2',
      levelAssociatedCancerType: {
        ...
        mainType: { id: null, name: 'Histiocytosis', tumorForm: 'LIQUID' },
        tissue: 'Myeloid',
        children: {},
        parent: 'HDCN',
        level: 4,
      ...
      levelExcludedCancerTypes: [],
      pmids: ['26287849', '29188284'],
      abstracts: [],
      description:
        'Vemurafenib is an orally available kinse inhibitor of V600-mutant BRAF that is FDA-approved for treatment of patients with Edheim-Chester Disease (ECD) harboring BRAF V600-mutations. FDA approval was based on the open-label, nonrandomized, multicohort VE-BASKET clinical trial of vemurafenib in BRAF V600E-mutant non-melanoma cancers in which 26 evaluable patients (ECD, n=22; LCH, n=4 ) achieved stable disease or better, and the confirmed overall response rate in ECD was 54.5% (12/22; 95% CI= 32.2-75.6%). Median progression-free survival and overall survival were not reached at study completion with a median follow-up of 28.8 months (PMID: 29188284, 26287849).',
    },
    {
      alterations: ['V600'],
      drugs: [
        { ncitCode: 'C64768', drugName: 'Vemurafenib' },
        { ncitCode: 'C106250', drugName: 'Atezolizumab' },
        { ncitCode: 'C68923', drugName: 'Cobimetinib' },
      ],
      approvedIndications: [],
      level: 'LEVEL_Dx1',
      fdaLevel: 'LEVEL_Fda2',
      levelAssociatedCancerType: {
        ...
        color: 'Black',
        name: 'Melanoma',
        mainType: { id: null, name: 'Melanoma', tumorForm: 'SOLID' },
        tissue: 'Skin',
        children: {},
        parent: 'SKIN',
        level: 2,
    ...
    },
    {
      alterations: ['V600 (excluding V600E and V600K)'],
      drugs: [
        { ncitCode: 'C98283', drugName: 'Encorafenib' },
        { ncitCode: 'C84865', drugName: 'Binimetinib' },
      ],
      approvedIndications: [],
      level: 'LEVEL_2',
      fdaLevel: 'LEVEL_Fda2',
    ...
    },
    {
      ...
      abstracts: [],
      description:
        'Vemurafenib and dabrafenib, inhibitors of BRAF V600E that are FDA-approved for patients with BRAF V600E or V600K mutant positive melanoma, are NCCN-listed for patients with Langerhans Cell Histiocytosis (LCH) harboring BRAF V600E mutations. NCCN recommendation is based on the Phase II VE BASKET study of vemurafenib in patients with BRAF V600E-mutant cancer in which four of four patients with LCH harboring BRAF V600E mutations had partial response to vemurafenib treatment (PMID: 29188284).',
    },
    {
      alterations: ['V600'],
      drugs: [{ ncitCode: 'C82386', drugName: 'Dabrafenib' }],
      approvedIndications: [],
      level: 'LEVEL_2',
      fdaLevel: 'LEVEL_Fda3',
      levelAssociatedCancerType: {
    ...
    },
    {
      alterations: ['V600 (excluding V600E and V600K)'],
      drugs: [
        { ncitCode: 'C82386', drugName: 'Dabrafenib' },
        { ncitCode: 'C77908', drugName: 'Trametinib' },
      ],
      approvedIndications: [],
      level: 'LEVEL_2',
      fdaLevel: 'LEVEL_Fda2',
    ...
    },
    {
      ...
      levelExcludedCancerTypes: [],
      pmids: ['31376203', '31213430', '25209580'],
      abstracts: [],
      description:
        'Vemurafenib and dabrafenib are orally available kinse inhibitors of V600-mutant BRAF that are FDA-approved for patients with unresectable or metastatic melanoma with the BRAF V600E mutation, and are NCCN-listed for patients with histiocytic neoplasms harboring BRAF V600 mutations. In a case study of a 40-year-old man with histiocytic sarcoma harboring a heterozygous BRAF V600E mutation, the patient was treated with vemurafenib and maintained both clinical and radiologic tumor responses for three months until disease progression (PMID: 25209580). In a separate case study of a 22-year-old woman with histiocytic sarcoma harboring a BRAF V600E mutation, the patient was treated with a combination of chemotherapy, antibiotics, steroids, and vemurafenib, and remained in complete remission eighteen months after treatment initiation (PMID: 31376203). An additional case study of a six-year-old child with BRAF V600E-mutant mixed systemic Rosai-Dorfman-Destombes disease and Langerhans cell histiocytosis reported sustained clinical and radiographic responses after treatment with dabrafenib prior to disease relapse at thirteen months (PMID: 31213430).',
    },
    {
      alterations: ['V600'],
      drugs: [{ ncitCode: 'C82386', drugName: 'Dabrafenib' }],
