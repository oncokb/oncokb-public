...
export enum PAGE_TITLE {
  ...
  ADMIN_USER_BANNER_MESSAGES = 'User Banner Messages',
  ...
  ADMIN_SUSPICIOUS_EMAIL_DOMAINS = 'Suspicious Email Domains',
...
export enum PAGE_ROUTE {
  ...
  ADMIN_USER_BANNER_MESSAGES = '/admin/user-banner-messages',
  ...
  ADMIN_EDIT_USER_BANNER_MESSAGE = '/admin/user-banner-messages/:id',
  ADMIN_COMPANY_DETAILS = '/admin/company-details',
  ADMIN_SUSPICIOUS_EMAIL_DOMAINS = '/admin/suspicious-email-domains',
...
export enum USER_AUTHORITY {
  ...
  ROLE_GENOMIC_REPORT = 'ROLE_GENOMIC_REPORT',
}
...
export const USER_AUTHORITIES = [
  ...
  USER_AUTHORITY.ROLE_SERVICE_ACCOUNT,
  USER_AUTHORITY.ROLE_GENOMIC_REPORT,
];
