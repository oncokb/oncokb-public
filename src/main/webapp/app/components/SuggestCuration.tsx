...
export const SuggestCuration = (props: { suggestion: string }) => {
  return (
    <DefaultTooltip overlay={`Suggest to annotate ${props.suggestion}`}>
      <ContactLink
        emailSubject={'Annotation suggestion for {{suggestion}}&&body=Thank you for using the feedback feature.%0APlease provide the following information for {{suggestion}} curation:%0A%0AEvidence:%0APMIDs:%0AAbstracts:'}
