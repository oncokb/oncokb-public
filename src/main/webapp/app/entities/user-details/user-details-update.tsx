          ...
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : userDetailsEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="accountTypeLabel" for="user-details-accountType">
                    Account Type
                  </Label>
                  <AvInput
                    id="user-details-accountType"
                    type="select"
                    className="form-control"
                    name="accountType"
                    value={(!isNew && userDetailsEntity.accountType) || 'ACADEMIC'}
                  >
                    <option value="ACADEMIC">ACADEMIC</option>
                    <option value="COMMERCIAL">COMMERCIAL</option>
                    <option value="NONAFFILIATED">NONAFFILIATED</option>
                  </AvInput>
                </AvGroup>
                <AvGroup>
