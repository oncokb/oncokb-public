...
export interface ITokenUpdateProps
  extends StateProps,
    DispatchProps,
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="oncokbPublicApp.token.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : tokenEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvInput
                  ...
                  value={
                    isNew
                      ? displayDefaultDateTime()
                      : convertDateTimeFromServer(props.tokenEntity.creation)
                  }
                />
              </AvGroup>
              <AvGroup>
                ...
                <AvInput
                  ...
                  value={
                    isNew
                      ? displayDefaultDateTime()
                      : convertDateTimeFromServer(props.tokenEntity.expiration)
                  }
                />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup>
                <Label id="numAccessIpsLabel" for="token-numAccessIps">
                  Num Access Ips
                </Label>
                <AvField
                  id="token-numAccessIps"
                  type="string"
                  className="form-control"
                  name="numAccessIps"
                  validate={{
