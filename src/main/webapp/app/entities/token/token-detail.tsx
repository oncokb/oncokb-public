      ...
      <Row>
        <Col md="8">
          ...
          <dl className="jh-entity-details">
            ...
            <dd>
              <TextFormat value={tokenEntity.creation} type="date" format={APP_LOCAL_DATE_FORMAT} />
            </dd>
            <dt>
              <span id="expiration">Expiration</span>
            </dt>
            <dd>
              <TextFormat value={tokenEntity.expiration} type="date" format={APP_LOCAL_DATE_FORMAT} />
            </dd>
            <dt>User</dt>
