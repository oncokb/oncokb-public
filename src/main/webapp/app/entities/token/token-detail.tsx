    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>
            {tokenEntity.creation ? (
              <TextFormat
                value={tokenEntity.creation}
                type="date"
          ...
          <dd>
            {tokenEntity.expiration ? (
              <TextFormat
                value={tokenEntity.expiration}
                type="date"
                format={APP_DATE_FORMAT}
              />
            ) : null}
          ...
          <dd>{tokenEntity.usageLimit}</dd>
          <dt>
            <span id="currentUsage">Current Usage</span>
          </dt>
          <dd>{tokenEntity.currentUsage}</dd>
          <dt>
            <span id="renewable">Renewable</span>
          </dt>
          <dd>{tokenEntity.renewable ? 'true' : 'false'}</dd>
          <dt>
            <span id="numAccessIps">Num Access Ips</span>
          </dt>
          <dd>{tokenEntity.numAccessIps}</dd>
          <dt>User</dt>
