  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="oncokbPublicApp.tokenStats.home.createOrEditLabel">Create or edit a TokenStats</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : tokenStatsEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="usageCountLabel" for="token-stats-usageCount">
                  Usage Count
                </Label>
                <AvField
                  id="token-stats-usageCount"
                  type="string"
                  className="form-control"
                  name="usageCount"
                  validate={{
