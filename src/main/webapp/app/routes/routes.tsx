...
const CancerGenesPage = lazy(() => import('app/pages/CancerGenesPage'));
const ActionableGenesPage = lazy(
  () => import('app/pages/actionableGenesPage/ActionableGenesPage')
);
import { RouterStore } from 'mobx-react-router';
const GenePage = lazy(() => import('app/pages/genePage/GenePage'));
const AlterationPage = lazy(
  () => import('app/pages/alterationPage/AlterationPage')
);
import { AccountPage } from 'app/pages/AccountPage';
const ActivateAccount = lazy(
  () => import('app/components/account/ActivateAccount')
);
...
const AccountPassword = lazy(
  () => import('app/components/account/AccountPassword')
);
import AdminRoutes from 'app/routes/AdminRoutes';
const PageContainer = lazy(() => import('app/components/PageContainer'));
...
const GenomicPage = lazy(() => import('app/pages/genomicPage/GenomicPage'));
const UserPage = lazy(() => import('app/pages/userPage/UserPage'));
import AppStore from 'app/store/AppStore';
const ActivateTrialFinish = lazy(
  () => import('app/components/account/ActivateTrialFinish')
);
const CompanyPage = lazy(() => import('app/pages/companyPage/CompanyPage'));
...
const OncologyTherapiesPage = lazy(
  () => import('app/pages/oncologyTherapiesPage/oncologyTherapiesPage')
);
import { NewsPageNavTab } from 'app/pages/newsPage/NewsPageNavTab';
const CompanionDiagnosticDevicePage = lazy(
  () =>
    import(
      'app/pages/companionDiagnosticDevicesPage/companionDiagnosticDevicePage'
    )
);
