import { REQUEST, SUCCESS } from 'app-backup/shared/reducers/action-type.util';
...
import profile, { ACTION_TYPES, getProfile } from 'app-backup/shared/reducers/application-profile';
