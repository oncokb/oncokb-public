...
module.exports = options => ({
  ...
  module: {
    rules: [
      ...
      {
        test: /\.(jpe?g|png|gif|svg|woff2?|otf|ttf|eot|ppt|pdf|zip|xlsx|tsv)$/i,
        loader: 'file-loader',
        options: {
          digest: 'hex',
          hash: 'sha512',
  ...
  plugins: [
    ...
    new CopyWebpackPlugin([
      ...
      {
        from: './src/main/webapp/content/images/favicon/favicon.ico',
        to: 'favicon.ico',
      },
      {
        from: './src/main/webapp/content/images/favicon/apple-touch-icon.png',
        to: 'apple-touch-icon.png',
      },
      {
        from: './src/main/webapp/content/images/favicon/browserconfig.xml',
